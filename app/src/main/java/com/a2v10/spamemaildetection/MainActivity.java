...
import static com.a2v10.spamemaildetection.HTMLUtils.extractPlainTextFromHtml;
...
//        String password = getIntent().getStringExtra("pass");
        ...
        String username = "shivnathjha024@gmail.com";
        String password = "kmrjjrgdbrazujud";
...
//            return fetch();
        ...
        protected void onPostExecute(ArrayList<String> strings) {
            ...
            Log.d("mytag", "onPostExecute: " + strings.size());
